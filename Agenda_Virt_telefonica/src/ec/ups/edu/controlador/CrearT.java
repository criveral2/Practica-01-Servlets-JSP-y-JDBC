...
/**
 * Servlet implementation class CrearT
 */
@WebServlet("/CrearT")
public class CrearT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("llegue al servlet Crear");
		...
		System.out.println(String.valueOf(usuarioo));
		 ...
		 System.out.println(tel.getUsuario().getCedula());
